...
PS3='Selecione o programa para a instalação: '
options=("Update" "Chrome" "Gnome-shell" "Git" "GitHub CLI" "VsCode" "VLC" "Spotify" "NVM" "Qbittorrent" "Sair")
    ...
    case $opt in
        "Update")
          echo "Atualizando repositórios......................"
            ...
            if ! apt-get update
            then 
              echo "Erro ao atualizar os repositórios."
            fi 
        ...
        "NVM")
          echo "Instalando NVM...................."
            if ! curl -o- https://raw.githubusercontent.com/nvm-sh/nvm/v0.35.3/install.sh | zsh
              then 
